...
if (!class_exists('UpdaterCloud_v1p0_StateStore', false)) :

    class UpdaterCloud_v1p0_StateStore
    {
        /**
        ...
        /**
         * @var UpdaterCloud_v1p0_Update|null Cached update.
         */
        ...
        /**
         * @return null|UpdaterCloud_v1p0_Update
         */
         ...
         * @return $this
         */
        public function setUpdate(UpdaterCloud_v1p0_Update $update = null)
        {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        ...
        public function save()
        {
            ...
            if (isset($this->update)) {
                ...
                if (UpdaterCloud_v1p0_Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load()
        {
            ...
            $this->lastCheck = intval(UpdaterCloud_v1p0_Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = UpdaterCloud_v1p0_Utils::get($state, 'checkedVersion', '');
            $this->update = null;
