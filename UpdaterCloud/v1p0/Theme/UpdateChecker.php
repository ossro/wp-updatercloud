...
if (!class_exists('UpdaterCloud_v1p0_Theme_UpdateChecker', false)) :

    class UpdaterCloud_v1p0_Theme_UpdateChecker extends UpdaterCloud_v1p0_UpdateChecker
    {
         ...
         *
         * @return UpdaterCloud_v1p0_Update|null An instance of Update, or NULL when no updates are available.
         */
        public function requestUpdate()
        {
            list($themeUpdate, $result) = $this->requestMetadata('UpdaterCloud_v1p0_Theme_Update', 'request_update');

            if ($themeUpdate !== null) {
                /** @var UpdaterCloud_v1p0_Theme_Update $themeUpdate */
        ...
        {
            return new UpdaterCloud_v1p0_Scheduler($this, $checkPeriod, array('load-themes.php'));
        }
        ...
        {
            return new UpdaterCloud_v1p0_DebugBar_Extension($this, 'UpdaterCloud_v1p0_DebugBar_ThemePanel');
        }
        ...
        {
            return new UpdaterCloud_v1p0_Theme_Package($this->stylesheet, $this);
        }
    }
