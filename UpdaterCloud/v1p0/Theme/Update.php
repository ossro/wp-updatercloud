...
if (!class_exists('UpdaterCloud_v1p0_Theme_Update', false)) :

    class UpdaterCloud_v1p0_Theme_Update extends UpdaterCloud_v1p0_Update
    {
        public $details_url = '';
         ...
         *
         * @param StdClass|UpdaterCloud_v1p0_Theme_Update $object The source object.
         * @return UpdaterCloud_v1p0_Theme_Update The new copy.
         */
        ...
        protected function validateMetadata($apiResponse)
        {
            ...
            foreach ($required as $key) {
                if (!isset($apiResponse->update->$key)
                    || empty($apiResponse->update->$key)
                ) {
                    return new WP_Error(
                        'updatercloud-invalid-metadata',
