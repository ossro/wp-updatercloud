...
if (!class_exists('UpdaterCloud_v1p0_UpdateChecker', false)) :

    abstract class UpdaterCloud_v1p0_UpdateChecker
    {
        ...
        /**
         * @var UpdaterCloud_v1p0_InstalledPackage
         */
        protected $package;

        /**
         * @var UpdaterCloud_v1p0_Scheduler
         */
        public $scheduler;

        /**
         * @var UpdaterCloud_v1p0_UpgraderStatus
         */
        protected $upgraderStatus;

        /**
         * @var UpdaterCloud_v1p0_StateStore
         */
        ...
        /**
         * Whether or not we should gather analytics data.
         *
         * @var bool
         */
        protected $gatherAnalyticsData;
         ...
         * @param boolean $gatherAnalyticsData
         */
        public function __construct(
            ...
            $this->gatherAnalyticsData = (bool) $gatherAnalyticsData;

            $this->package = $this->createInstalledPackage();
            $this->scheduler = $this->createScheduler($checkPeriod);
            $this->upgraderStatus = new UpdaterCloud_v1p0_UpgraderStatus();
            $this->updateState = new UpdaterCloud_v1p0_StateStore($this->optionName);
         ...
         *
         * @return UpdaterCloud_v1p0_InstalledPackage
         */
         ...
         * @return UpdaterCloud_v1p0_Scheduler
         */
         ...
         *
         * @return UpdaterCloud_v1p0_Update|null
         */
        public function checkForUpdates()
        {
            ...
            add_action('updatercloud_api_error', array($this, 'collectApiErrors'), 10, 4);
            ...
            remove_action('updatercloud_api_error', array($this, 'collectApiErrors'), 10);
         ...
         *
         * @return UpdaterCloud_v1p0_StateStore
         */
         ...
         *
         * @return UpdaterCloud_v1p0_Update An instance of Update, or NULL when no updates are available.
         */
         ...
         *
         * @param UpdaterCloud_v1p0_Metadata|null $update
         */
        protected function fixSupportedWordpressVersion(UpdaterCloud_v1p0_Metadata $update = null)
        {
         ...
         *
         * This method adds the "updatercloud_" prefix and the "-$slug" suffix to the filter name.
         * For example, "pre_inject_update" becomes "updatercloud_pre_inject_update-plugin-slug".
         *
        ...
        /* -------------------------------------------------------------------
         * WP-UpdaterCloud filters and filter utilities
         * -------------------------------------------------------------------
         */
         ...
         *
         * Identical to add_filter(), except it automatically adds the "updatercloud_" prefix
         * and the "-$slug" suffix to the filter name. For example, "request_info_result"
         * becomes "updatercloud_request_info_result-your_plugin_slug".
         *
         * @param string $tag
         ...
         * support automatic updates installation for mu-plugins, so WP-UpdaterCloud usually won't show update
         ...
         * @return array [UpdaterCloud_v1p0_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
         */
        protected function requestMetadata($metaClass, $filterRoot, $queryArgs = array())
        {
            //Query args to append to the URL.
            $queryArgs = array_merge(
                $this->analytics()->gather(),
                $queryArgs
            );
            ...
            if (!is_wp_error($status)) {
                ...
                do_action('updatercloud_api_error', $status, $result, $url, $this->slug);
                $this->triggerError(
            ...
            if ($metadata->download_url ?? false) {
                $metadata->download_url = $this->addDownloadUrlQueryArgs($metadata->download_url);
            }
        ...
        protected function validateApiResponse($result)
        {
            ...
            if ($result['response']['code'] !== 200) {
                return new WP_Error(
                    'updatercloud_unexpected_response_code',
                    'HTTP response code is ' . $result['response']['code'] . ' (expected: 200)'
                );
            }

            if (empty($result['body'])) {
                return new WP_Error('updatercloud_empty_response', 'The metadata file appears to be empty.');
            }
        ...
        public function fixDirectoryName($source, $remoteSource, $upgrader)
        {
            ...
            if ($source !== $correctedSource) {
                ...
                if ($this->isBadDirectoryStructure($remoteSource)) {
                    return new WP_Error(
                        'updatercloud-incorrect-directory-structure',
                        sprintf(
        ...
        {
            return new UpdaterCloud_v1p0_DebugBar_Extension($this);
        }

        protected function analytics()
        {
            return new UpdaterCloud_v1p0_Analytics($this);
        }

        /**
         * Add analytics query args to download url.
         *
         * @param string $url
         *
         * @return void
         */
        protected function addDownloadUrlQueryArgs(string $url)
        {
            if ($this->downloadKey) {
                $url = add_query_arg(
                    [
                        'download_key' => $this->downloadKey,
                    ],
                    $url
                );
            }

            if (!$this->gatherAnalyticsData) {
                return $url;
            }

            $queryArgs = $this->analytics()->gather();
         ...
         *
         * @param UpdaterCloud_v1p0_DebugBar_Panel $panel
         */
