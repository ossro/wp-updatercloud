<?php
if (!class_exists('UpdaterCloud_v1p0_DebugBar_Extension', false)) :

    class UpdaterCloud_v1p0_DebugBar_Extension
    {
        const RESPONSE_BODY_LENGTH_LIMIT = 4000;

        /** @var UpdaterCloud_v1p0_UpdateChecker */
        protected $updateChecker;
        protected $panelClass = 'UpdaterCloud_v1p0_DebugBar_Panel';
        ...
        public function __construct($updateChecker, $panelClass = null)
        {
            ...
            add_action('wp_ajax_updatercloud_v1_debug_check_now', array($this, 'ajaxCheckNow'));
        }

        /**
         * Register the WP-UpdaterCloud Debug Bar panel.
         *
         * @param array $panels
         * @return array
         */
        ...
        {
            wp_enqueue_style(
                'updatercloud-debug-bar-style-v1',
                $this->getLibraryUrl("/css/updatercloud-debug-bar.css"),
                array('debug-bar'),
                '20171124'
            );

            wp_enqueue_script(
                'updatercloud-debug-bar-js-v1',
        ...
        protected function preAjaxRequest()
        {
            ...
            check_ajax_referer('updatercloud-ajax');
        ...
        private function getLibraryUrl($filePath)
        {
            ...
            $absolutePath = UpdaterCloud_v1p0_Factory::normalizePath($absolutePath);

            $pluginDir = UpdaterCloud_v1p0_Factory::normalizePath(WP_PLUGIN_DIR);
            $muPluginDir = UpdaterCloud_v1p0_Factory::normalizePath(WPMU_PLUGIN_DIR);
            $themeDir = UpdaterCloud_v1p0_Factory::normalizePath(get_theme_root());
