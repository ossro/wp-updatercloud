<?php
if (!class_exists('UpdaterCloud_v1p0_Scheduler', false)) :

    /**
     * The scheduler decides when and how often to check for updates.
     * It calls @see UpdaterCloud_v1p0_UpdateChecker::checkForUpdates() to perform the actual checks.
     */
    class UpdaterCloud_v1p0_Scheduler
    {
         ...
         *
         * @param UpdaterCloud_v1p0_UpdateChecker $updateChecker
        ...
        public function upgraderProcessComplete(
            ...
            //Cancel all further actions if the current version of WP-UpdaterCloud has been deleted or overwritten
            ...
            if (is_a($this->updateChecker, 'UpdaterCloud_v1p0_Theme_UpdateChecker')) {
            ...
            if (is_a($this->updateChecker, 'UpdaterCloud_v1p0_Plugin_UpdateChecker')) {
         ...
         *
         * You can override the default behaviour by using the "updatercloud_check_now-$slug" filter.
