<?php
if (!class_exists('UpdaterCloud_v1p0_Plugin_Info', false)) :
     ...
     * @access public
     */
    class UpdaterCloud_v1p0_Plugin_Info extends UpdaterCloud_v1p0_Metadata
    {
        public $name;
        public $slug;
        public $version;
        ...
        {
            if (
                !is_object($apiResponse->update)
                || !isset($apiResponse->update->name, $apiResponse->update->version)
                || empty($apiResponse->update->name)
                || empty($apiResponse->update->version)
            ) {
                return new WP_Error(
