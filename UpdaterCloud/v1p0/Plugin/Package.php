<?php
if (!class_exists('UpdaterCloud_v1p0_Plugin_Package', false)) :

    class UpdaterCloud_v1p0_Plugin_Package extends UpdaterCloud_v1p0_InstalledPackage
    {
        /**
        ...
        public function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                if (($muPluginDir === false) || ($pluginPath === false)) {
                    ...
                    $pluginPath  = UpdaterCloud_v1p0_Factory::normalizePath($this->pluginAbsolutePath);
                }
