<?php
if (!class_exists('UpdaterCloud_v1p0_Plugin_UpdateChecker', false)) :
     ...
     * @access public
     */
    class UpdaterCloud_v1p0_Plugin_UpdateChecker extends UpdaterCloud_v1p0_UpdateChecker
    {
        ...
        /**
         * @var UpdaterCloud_v1p0_Plugin_Package
         */
        protected $package;
        ...
        public function __construct(
            ...
            $slugCheckFilter = 'updatercloud_is_slug_in_use-' . $slug;
            ...
            parent::__construct($metadataUrl, dirname($this->pluginFile), $slug, $checkPeriod, $optionName, $downloadKey, $gatherAnalyticsData);
            ...
            $this->extraUi = new UpdaterCloud_v1p0_Plugin_Ui($this);
        }
        ...
        {
            $scheduler = new UpdaterCloud_v1p0_Scheduler($this, $checkPeriod, array('load-plugins.php'));
         ...
         * hook. During uninstallation, WP includes the main plugin file (which creates a WP-UpdaterCloud instance),
         * the uninstall hook runs, WP deletes the plugin files and then updates some transients.
         * If WP-UpdaterCloud hooks are still around at this time, they could throw an error while trying to
         ...
         * most other WP-UpdaterCloud hooks to be safe.
         *
         * @internal
         */
         ...
         * @return UpdaterCloud_v1p0_Plugin_Info
         */
        public function requestInfo($queryArgs = array())
        {
            list($pluginInfo, $result) = $this->requestMetadata('UpdaterCloud_v1p0_Plugin_Info', 'request_info', $queryArgs);

            if ($pluginInfo !== null) {
                /** @var UpdaterCloud_v1p0_Plugin_Info $pluginInfo */
         ...
         *
         * @return UpdaterCloud_v1p0_Update|null An instance of Plugin_Update, or NULL when no updates are available.
         */
        public function requestUpdate()
        {
            ...
            $update = UpdaterCloud_v1p0_Plugin_Update::fromPluginInfo($pluginInfo);
        ...
        public function getUpdate()
        {
            ...
            if (isset($update)) {
                /** @var UpdaterCloud_v1p0_Plugin_Update $update */
        ...
        {
            return new UpdaterCloud_v1p0_DebugBar_PluginExtension($this);
        }
        ...
        {
            return new UpdaterCloud_v1p0_Plugin_Package($this->pluginAbsolutePath, $this);
        }

        /**
         * @return UpdaterCloud_v1p0_Plugin_Package
         */
