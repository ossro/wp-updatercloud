...
if (!class_exists('UpdaterCloud_v1p0_Factory', false)) :
     ...
     * versions by calling {@link UpdaterCloudFactory::addVersion()}.
     *
     * At the moment it can only build instances of the UpdateChecker class. Other classes are
     * intended mainly for internal use and refer directly to specific implementations.
     */
    class UpdaterCloud_v1p0_Factory
    {
         ...
         *
         * @see UpdaterCloud_v1p0_UpdateChecker::__construct
         *
         ...
         *
         * @return UpdaterCloud_v1p0_Plugin_UpdateChecker|UpdaterCloud_v1p0_Theme_UpdateChecker
         */
        public static function buildUpdateChecker(
            ...
            if (self::isPluginFile($fullPath)) {
                ...
                throw new RuntimeException(sprintf(
                    ...
                    'This is a bug. Please contact the WP-UpdaterCloud developer.',
            ...
            if ($checkerClass === null) {
                trigger_error(
                    sprintf(
                        'WP-UpdaterCloud %s does not support updates for %ss',
            ...
            return new $checkerClass($metadataUrl, $id, $slug, $checkPeriod, $optionName, $muPluginFile, $downloadKey, $gatherAnalyticsData);
        }
