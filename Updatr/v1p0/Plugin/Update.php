<?php
if (!class_exists('Updatr_v1p0_Plugin_Update', false)) :
     ...
     * @access public
     */
    class Updatr_v1p0_Plugin_Update extends Updatr_v1p0_Update
    {
        public $id = 0;
        public $homepage;
        ...
        public static function fromJson($json)
        {
            ...
            $pluginInfo = Updatr_v1p0_Plugin_Info::fromJson($json);
            if ($pluginInfo !== null) {
         ...
         *
         * @param Updatr_v1p0_Plugin_Info $info
         * @return Updatr_v1p0_Plugin_Update
         */
         ...
         *
         * @param StdClass|Updatr_v1p0_Plugin_Info|Updatr_v1p0_Plugin_Update $object The source object.
         * @return Updatr_v1p0_Plugin_Update The new copy.
         */
