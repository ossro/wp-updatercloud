<?php
if (!class_exists('Updatr_v1p0_Plugin_UpdateChecker', false)) :
     ...
     * @access public
     */
    class Updatr_v1p0_Plugin_UpdateChecker extends Updatr_v1p0_UpdateChecker
    {
        ...
        /**
         * @var Updatr_v1p0_Plugin_Package
         */
        protected $package;
        ...
        public function __construct(
            ...
            $slugCheckFilter = 'updatr_is_slug_in_use-' . $slug;
            ...
            $this->extraUi = new Updatr_v1p0_Plugin_Ui($this);
        }
        ...
        {
            $scheduler = new Updatr_v1p0_Scheduler($this, $checkPeriod, array('load-plugins.php'));
         ...
         * hook. During uninstallation, WP includes the main plugin file (which creates a WP-Updatr instance),
         * the uninstall hook runs, WP deletes the plugin files and then updates some transients.
         * If WP-Updatr hooks are still around at this time, they could throw an error while trying to
         ...
         * most other WP-Updatr hooks to be safe.
         *
         * @internal
         */
         ...
         * @return Updatr_v1p0_Plugin_Info
         */
        public function requestInfo($queryArgs = array())
        {
            list($pluginInfo, $result) = $this->requestMetadata('Updatr_v1p0_Plugin_Info', 'request_info', $queryArgs);

            if ($pluginInfo !== null) {
                /** @var Updatr_v1p0_Plugin_Info $pluginInfo */
         ...
         *
         * @return Updatr_v1p0_Update|null An instance of Plugin_Update, or NULL when no updates are available.
         */
        public function requestUpdate()
        {
            ...
            $update = Updatr_v1p0_Plugin_Update::fromPluginInfo($pluginInfo);
         ...
         *
         * @return Updatr_v1p0_Plugin_Update|null
         */
        public function getUpdate()
        {
            $update = parent::getUpdate();
            if (isset($update)) {
                /** @var Updatr_v1p0_Plugin_Update $update */
        ...
        {
            return new Updatr_v1p0_DebugBar_PluginExtension($this);
        }
        ...
        {
            return new Updatr_v1p0_Plugin_Package($this->pluginAbsolutePath, $this);
        }

        /**
         * @return Updatr_v1p0_Plugin_Package
         */
