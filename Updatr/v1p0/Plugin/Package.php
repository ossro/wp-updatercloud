<?php
if (!class_exists('Updatr_v1p0_Plugin_Package', false)) :

    class Updatr_v1p0_Plugin_Package extends Updatr_v1p0_InstalledPackage
    {
        /**
        ...
        public function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                if (($muPluginDir === false) || ($pluginPath === false)) {
                    ...
                    $pluginPath  = Updatr_v1p0_Factory::normalizePath($this->pluginAbsolutePath);
                }
