...
if (!class_exists('Updatr_v1p0_StateStore', false)) :

    class Updatr_v1p0_StateStore
    {
        /**
        ...
        /**
         * @var Updatr_v1p0_Update|null Cached update.
         */
        ...
        /**
         * @return null|Updatr_v1p0_Update
         */
         ...
         * @return $this
         */
        public function setUpdate(Updatr_v1p0_Update $update = null)
        {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        ...
        public function save()
        {
            ...
            if (isset($this->update)) {
                ...
                if (Updatr_v1p0_Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load()
        {
            ...
            $this->lastCheck = intval(Updatr_v1p0_Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = Updatr_v1p0_Utils::get($state, 'checkedVersion', '');
            $this->update = null;
