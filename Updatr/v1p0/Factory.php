...
if (!class_exists('Updatr_v1p0_Factory', false)) :
     ...
     * versions by calling {@link UpdatrFactory::addVersion()}.
     *
     * At the moment it can only build instances of the UpdateChecker class. Other classes are
     * intended mainly for internal use and refer directly to specific implementations.
     */
    class Updatr_v1p0_Factory
    {
         ...
         *
         * @see Updatr_v1p0_UpdateChecker::__construct
         *
         ...
         *
         * @return Updatr_v1p0_Plugin_UpdateChecker|Updatr_v1p0_Theme_UpdateChecker
         */
        public static function buildUpdateChecker(
            ...
            if (self::isPluginFile($fullPath)) {
                ...
                throw new RuntimeException(sprintf(
                    ...
                    'This is a bug. Please contact the WP-Updatr developer.',
            ...
            if ($checkerClass === null) {
                trigger_error(
                    sprintf(
                        'WP-Updatr %s does not support updates for %ss',
