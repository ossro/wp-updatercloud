...
if (!class_exists('Updatr_v1p0_Theme_UpdateChecker', false)) :

    class Updatr_v1p0_Theme_UpdateChecker extends Updatr_v1p0_UpdateChecker
    {
         ...
         *
         * @return Updatr_v1p0_Update|null An instance of Update, or NULL when no updates are available.
         */
        public function requestUpdate()
        {
            list($themeUpdate, $result) = $this->requestMetadata('Updatr_v1p0_Theme_Update', 'request_update');

            if ($themeUpdate !== null) {
                /** @var Updatr_v1p0_Theme_Update $themeUpdate */
        ...
        {
            return new Updatr_v1p0_Scheduler($this, $checkPeriod, array('load-themes.php'));
        }
        ...
        {
            return new Updatr_v1p0_DebugBar_Extension($this, 'Updatr_v1p0_DebugBar_ThemePanel');
        }
        ...
        {
            return new Updatr_v1p0_Theme_Package($this->stylesheet, $this);
        }
    }
