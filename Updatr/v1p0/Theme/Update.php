...
if (!class_exists('Updatr_v1p0_Theme_Update', false)) :

    class Updatr_v1p0_Theme_Update extends Updatr_v1p0_Update
    {
        public $details_url = '';
         ...
         *
         * @param StdClass|Updatr_v1p0_Theme_Update $object The source object.
         * @return Updatr_v1p0_Theme_Update The new copy.
         */
