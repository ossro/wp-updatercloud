...
if (!class_exists('Updatr_v1p0_Metadata', false)) :
     ...
     * @access public
     */
    abstract class Updatr_v1p0_Metadata
    {
        /**
        ...
        protected static function createFromJson($json, $target)
        {
            ...
            if (empty($apiResponse) || !is_object($apiResponse)) {
                ...
                do_action('updatr_api_error', new WP_Error('updatr-invalid-json', $errorMessage));
            ...
            if (is_wp_error($valid)) {
                do_action('updatr_api_error', $valid);
