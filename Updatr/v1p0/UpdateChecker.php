...
if (!class_exists('Updatr_v1p0_UpdateChecker', false)) :

    abstract class Updatr_v1p0_UpdateChecker
    {
        ...
        /**
         * @var Updatr_v1p0_InstalledPackage
         */
        protected $package;

        /**
         * @var Updatr_v1p0_Scheduler
         */
        public $scheduler;

        /**
         * @var Updatr_v1p0_UpgraderStatus
         */
        protected $upgraderStatus;

        /**
         * @var Updatr_v1p0_StateStore
         */
        ...
        public function __construct(
            ...
            $this->upgraderStatus = new Updatr_v1p0_UpgraderStatus();
            $this->updateState = new Updatr_v1p0_StateStore($this->optionName);
         ...
         *
         * @return Updatr_v1p0_InstalledPackage
         */
         ...
         *
         * @return Updatr_v1p0_Update|null
         */
        public function checkForUpdates()
        {
            ...
            add_action('updatr_api_error', array($this, 'collectApiErrors'), 10, 4);
            ...
            remove_action('updatr_api_error', array($this, 'collectApiErrors'), 10);
         ...
         *
         * @return Updatr_v1p0_Update An instance of Update, or NULL when no updates are available.
         */
         ...
         *
         * @param Updatr_v1p0_Metadata|null $update
         */
        protected function fixSupportedWordpressVersion(Updatr_v1p0_Metadata $update = null)
        {
         ...
         *
         * This method adds the "updatr_" prefix and the "-$slug" suffix to the filter name.
         * For example, "pre_inject_update" becomes "updatr_pre_inject_update-plugin-slug".
         *
        ...
        /* -------------------------------------------------------------------
         * WP-Updatr filters and filter utilities
         * -------------------------------------------------------------------
         */
         ...
         *
         * Identical to add_filter(), except it automatically adds the "updatr_" prefix
         * and the "-$slug" suffix to the filter name. For example, "request_info_result"
         * becomes "updatr_request_info_result-your_plugin_slug".
         *
         * @param string $tag
         ...
         * support automatic updates installation for mu-plugins, so WP-Updatr usually won't show update
         ...
         * @return array [Updatr_v1p0_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
         */
        protected function requestMetadata($metaClass, $filterRoot, $queryArgs = array())
        {
            ...
            if (!is_wp_error($status)) {
                ...
                do_action('updatr_api_error', $status, $result, $url, $this->slug);
                $this->triggerError(
        ...
        protected function validateApiResponse($result)
        {
            ...
            if ($result['response']['code'] !== 200) {
                return new WP_Error(
                    'updatr_unexpected_response_code',
                    'HTTP response code is ' . $result['response']['code'] . ' (expected: 200)'
                );
            }

            if (empty($result['body'])) {
                return new WP_Error('updatr_empty_response', 'The metadata file appears to be empty.');
            }
        ...
        public function fixDirectoryName($source, $remoteSource, $upgrader)
        {
            ...
            if ($source !== $correctedSource) {
                ...
                if ($this->isBadDirectoryStructure($remoteSource)) {
                    return new WP_Error(
                        'updatr-incorrect-directory-structure',
                        sprintf(
        ...
        {
            return new Updatr_v1p0_DebugBar_Extension($this);
        }

        protected function analytics()
        {
            return new Updatr_v1p0_Analytics($this);
        }
         ...
         *
         * @param Updatr_v1p0_DebugBar_Panel $panel
         */
