<?php
if (!class_exists('Updatr_v1p0_DebugBar_Extension', false)) :

    class Updatr_v1p0_DebugBar_Extension
    {
        const RESPONSE_BODY_LENGTH_LIMIT = 4000;

        /** @var Updatr_v1p0_UpdateChecker */
        protected $updateChecker;
        protected $panelClass = 'Updatr_v1p0_DebugBar_Panel';
        ...
        public function __construct($updateChecker, $panelClass = null)
        {
            ...
            add_action('wp_ajax_updatr_v1_debug_check_now', array($this, 'ajaxCheckNow'));
        }

        /**
         * Register the WP-Updatr Debug Bar panel.
         *
         * @param array $panels
         * @return array
         */
        ...
        {
            wp_enqueue_style(
                'updatr-debug-bar-style-v1',
                $this->getLibraryUrl("/css/updatr-debug-bar.css"),
                array('debug-bar'),
                '20171124'
            );

            wp_enqueue_script(
                'updatr-debug-bar-js-v1',
        ...
        protected function preAjaxRequest()
        {
            ...
            check_ajax_referer('updatr-ajax');
        ...
        private function getLibraryUrl($filePath)
        {
            ...
            $absolutePath = Updatr_v1p0_Factory::normalizePath($absolutePath);

            $pluginDir = Updatr_v1p0_Factory::normalizePath(WP_PLUGIN_DIR);
            $muPluginDir = Updatr_v1p0_Factory::normalizePath(WPMU_PLUGIN_DIR);
            $themeDir = Updatr_v1p0_Factory::normalizePath(get_theme_root());
